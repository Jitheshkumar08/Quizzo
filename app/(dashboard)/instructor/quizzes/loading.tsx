export default function InstructorQuizzesLoading() {
  return (
    <div className="space-y-6 animate-fade-in-up w-full">
      ...
      <div className="flex items-center justify-between">
        ...
        {/* NEW QUIZ Button Skeleton */}
        <div className="h-[46px] w-[140px] rounded-full bg-black/10 animate-pulse"></div>
      </div>
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div key={i} className="glass rounded-2xl p-5 flex items-start gap-4 relative overflow-hidden">
            ...
            <div className="flex items-center gap-2 flex-shrink-0 relative z-10">
              ...
              <div className="w-[52px] h-[32px] rounded-lg bg-purple-400/20 animate-pulse"></div>
            </div>
          </div>
        ))}
      </div>
