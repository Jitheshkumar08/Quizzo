...
export default function ScrollToTop() {
  ...
  const mobileAllowedPaths = ["/edit", "/upload", "/admin/attempts", "/admin/users", "/admin/quizzes", "/instructor/quizzes", "/student/browse"];
  const isAllowedOnMobile = mobileAllowedPaths.some((p) => pathname?.includes(p));
